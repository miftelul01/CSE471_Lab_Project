...
export const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    api: [
      ...
      "app/api/chores/[choreId]/route.ts",
      "app/api/chores/[choreId]/due-date-suggestion/route.ts",
      "app/api/chores/assignments/[assignmentId]/route.ts",
      "app/api/chores/assignments/[assignmentId]/reschedule/route.ts",
      "app/api/chores/assignments/[assignmentId]/calendar-check/route.ts",
      "app/api/chores/assignments/[assignmentId]/split/route.ts",
      "app/api/chores/assignments/[assignmentId]/subtasks/[subtaskId]/route.ts",
      "app/api/chores/assignments/[assignmentId]/ratings/route.ts",
      "app/api/chores/absences/route.ts",
      "app/api/chores/absences/[id]/route.ts",
      "app/api/chores/swaps/route.ts",
      "app/api/chores/swaps/[id]/route.ts",
      "app/api/chores/marketplace/route.ts",
      "app/api/chores/marketplace/[id]/route.ts",
      "app/api/chores/settings/route.ts",
      "app/api/cron/chores/route.ts",
      "app/api/google/connect/route.ts",
      "app/api/google/connect/callback/route.ts",
    ...
    tables: [
      ...
      "chore_absences",
      "chore_swap_requests",
      "chore_marketplace_posts",
      "chore_subtasks",
      "chore_quality_ratings",
      "google_credentials",
    ],
    status: "done",
  },
