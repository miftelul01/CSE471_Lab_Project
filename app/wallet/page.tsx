  ...
  return (
    <FeatureStub
      ...
      checklist={[
        ...
        "Add a 'mark as paid' button for your own share. Card/bKash payment is M3.2 and flips the same rows via webhook.",
        "M2.3 (meal attendance) writes adjustments against these shares — agree the shape with Araf before you finalise the split logic.",
      ]}
    />
  );
}
