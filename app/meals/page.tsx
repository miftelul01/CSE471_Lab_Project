  ...
  return (
    <FeatureStub
      ...
      checklist={[
        ...
        "Cost adjustment: when someone skips, their share of that meal's cost comes off their expense_shares row from M2.1. Agree the mechanism with Miftelul — either a negative adjustment expense or a direct share update.",
        ...
        "Auto-create the day's meal rows (a small job or on first view), optionally linked to the approved menu_proposal from M2.2.",
      ]}
    />
  );
}
